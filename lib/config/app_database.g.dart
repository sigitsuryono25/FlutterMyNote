    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `tb_note` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `judul` TEXT, `isi` TEXT)');
...
class _$NoteDao extends NoteDao {
  ...
  Future<int> insertNote(NoteModel model) {
    return _noteModelInsertionAdapter.insertAndReturnId(
        model, OnConflictStrategy.replace);
  }

  @override
  Future<int> deleteNote(NoteModel model) {
    return _noteModelDeletionAdapter.deleteAndReturnChangedRows(model);
  }
}
